...
<html>
<head>
    <title>FundHer | Contact Form</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
	<link href="//netdna.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet" media="screen">
	<link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans+Condensed|Lobster" rel="stylesheet" type="text/css">
	<STYLE type="text/css">
		.jumbotron .container {background-color: #000000}
		.jumbotron .container h1 {font-family: 'Lobster', cursive; color: #c912ad; text-align: center;}
		.jumbotron .container p {font-family: 'IBM Plex Sans Condensed', sans-serif; color: #ffffff; text-align: center;}
		.jumbotron .container p span {color: #42dcf4;}
	</STYLE>
</head>
<body>
    <div class="jumbotron">
        <div class="container">
            <h1>FundHer</h1>
            <p>Did you love your lunch? Do you have a candidate to recommend? Do you have suggestions for how to make FundHer better? </br><span>Tell us what you think!</span></p>
        </div>
    </div>
